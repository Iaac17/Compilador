...
tokens = (
    ...
    ,'SUMA' , 'PARIZQ', 'PARDER', 'LLAIZQ', 'LLADER', 'CORIZQ', 'CORDER'
)
...
def t_RESERVADA(t):    
    r'(for|while|do|if|else|program|using|namespace|class|static|string)'
    return t

def t_RESERVADO(t):
    r'(public|static|System|void|out|int|println|read|printf|end|Main|args|Console|WriteLine)'
    return t
