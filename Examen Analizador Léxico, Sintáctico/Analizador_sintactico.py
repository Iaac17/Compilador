...
def p_expresion(p):
    ...
    expresion : RESERVADA PARIZQ RESERVADO IDENTIFICADOR OPERADOR ENTERO SIMBOLO IDENTIFICADOR OPERADOR ENTERO SIMBOLO IDENTIFICADOR PLUSPLUS PARDER LLAIZQ RESERVADO SIMBOLO RESERVADO SIMBOLO RESERVADO PARIZQ COMDOB IDENTIFICADOR DOSPUNTO COMDOB SUMA IDENTIFICADOR PARDER SIMBOLO LLADER
              ...
              | LLAIZQ LLADER
              | RESERVADA RESERVADO SIMBOLO RESERVADA IDENTIFICADOR LLAIZQ RESERVADA IDENTIFICADOR LLAIZQ RESERVADA RESERVADO RESERVADO PARIZQ RESERVADA CORIZQ CORDER RESERVADO PARDER LLAIZQ RESERVADO SIMBOLO RESERVADO SIMBOLO RESERVADO PARIZQ COMDOB IDENTIFICADOR COMDOB PARDER SIMBOLO LLADER LLADER LLADER 
    ...
    '''
    if len(p) == 34:
        p[0] = "Expresión correcta (programa 'Hello World')"
    elif len(p) == 31:
